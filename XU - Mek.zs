//XU
val genSurvivalist = <ExtraUtilites|generator>;
val genFurnace = <ExtraUtilites|generator:1>;
val genLava = <ExtraUtilites|generator:2>;
val genEnder = <ExtraUtilites|generator:3>;
val genRedstoneHeated = <ExtraUtilites|generator:4>;
val genCulinary = <ExtraUtilites|generator:5>;
val genPotions = <ExtraUtilites|generator:6>;
val genSolar = <ExtraUtilites|generator:7>;
val genTNT = <ExtraUtilites|generator:8>;
val genPink = <ExtraUtilites|generator:9>;
val genHighTemp = <ExtraUtilites|generator:10>;
val genNetherStar = <ExtraUtilites|generator:11>;
val postTrading = <ExtraUtilites|trading_post>;
val nodeItem = <ExtraUtilites|extractor_base>;
val nodeLiquid = <ExtraUtilites|extractor_base:6>;
val nodeEnergy = <ExtraUtilites|extractor_base:12>;
val pipeTransfer = <ExtraUtilites|pipes>;
val pipeSorting = <ExtraUtilites|pipes:8>;
val pipeFilter = <ExtraUtilites|pipes:9>;
val pipeRationing = <ExtraUtilites|pipes:10>;
val pipeEnergy = <ExtraUtilites|pipes:11>;
val pipeCrossover = <ExtraUtilites|pipes:12>;
val pipeSortingMod = <ExtraUtilites|pipes:13>;
val pipeEnergyExtraction = <ExtraUtilites|pipes:14>;
val pipeRationingHyper = <ExtraUtilites|pipes.1>;
val nodeItemRetrieval = <ExtraUtilites|extractor_base_remote>;
val nodeLiquidRetrieval = <ExtraUtilites|extractor_base_remote:6>;
val canWatering = <ExtraUtilites|watering_can:1>;
