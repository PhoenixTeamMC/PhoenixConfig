...
##MFR
val laserFocusBlue = <MineFactoryReloaded:item.mfr.laserfocus:11>;

##mekanisim
val panelSolar = <MekanismGenerators:SolarPanel>;
val alloyEnriched = <Mekanism:EnrichedAlloy>;

##EIO
val alloyConductive = <EnderIO:itemAlloy:4>;
val steelDark = <EnderIO:itemAlloy:6>;
...
val paneBlue = <minecraft:stained_glass_pane:11>;
val redstone = <minecraft:redstone>;
val ballSlimeDict = <ore:ballSlime>;

##mariculture
val batteryCopper = <Mariculture:battery_copper>;

##Opencomputers
val microchipT3 = <OpenComputers:item:26>;

##custom
val redstoneMemoric = <CustomItems:customItem0>;

ballSlimeDict.add(<MineFactoryReloaded:item.mfr.pinkslimeball>);
ballSlimeDict.add(<TConstruct:strangeFood>);
ballSlimeDict.add(slimeBall);
ballSlimeDict.add(<TConstruct:materials:36>);
ballSlimeDict.remove(<TConstruct:slime.gel:*>);

//mek salt in pams recipies.
val salt = <ore:foodSalt>;
salt.add(<Mekanism:Salt>);

//no more mek cables because tps lag.
recipes.remove(<Mekanism:PartTransmitter:*>);

//remember.
<harvestcraft:peanutbuttercookiesItem>.displayName = "Remember Esme";

//more fitting solar recipies.
recipes.remove (<ExtraUtilities:generator:7>);
recipes.addShaped(<ExtraUtilities:generator:7>,
[[laserFocusBlue, panelSolar, laserFocusBlue],
 [panelSolar, microchipT3, panelSolar],
 [alloyConductive, cellHardened, alloyConductive]]);

recipes.remove (panelSolar);
recipes.addShaped(panelSolar,
[[paneBlue, paneBlue, paneBlue],
 [alloyConductive, alloyEnriched, batteryCopper],
 [steelDark, steelDark, steelDark]]);


recipes.remove (<Mariculture:battery_copper:*>);
recipes.addShaped(batteryCopper,
[[null, alloyConductive, null],
 [ingotCopperdict, redstoneMemoric, ingotCopperdict],
 [ingotCopperdict, redstoneMemoric, ingotCopperdict]]);

recipes.addShaped(redstoneMemoric *5,
[[ballSlimeDict, redstone, ballSlimeDict],
 [redstone, redstone, redstone],
 [<minecraft:snowball>, redstone, <minecraft:snowball>]]);

print("Vaelrecipies loaded");
